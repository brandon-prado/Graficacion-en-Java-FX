...
public class Wayzz extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        Scene scene = new Scene(root, 500, 500, Color.rgb(224, 151, 115));
        ...
        gc.setLineWidth(2);
        gc.setStroke(Color.BLACK);
        gc.setFill(Color.rgb(86, 164, 90));
        gc.beginPath();
