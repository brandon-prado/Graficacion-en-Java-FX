...
public class Tikki extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        Scene scene = new Scene(root, 500, 500, Color.rgb(129, 112, 193));
        ...
        //BOCA
        gc.setLineWidth(1.5);
        gc.setStroke(Color.rgb(106, 40, 35));
        gc.setFill(Color.rgb(106, 40, 35));
        gc.beginPath();
        ...
        //MANCHA SUPERIOR
        gc.setLineWidth(1.0);
        gc.setStroke(Color.rgb(40, 40, 42));
        gc.setFill(Color.BLACK);
        gc.beginPath();
        ...
        //DETALLES
        gc.setLineWidth(1.0);
        gc.setStroke(Color.rgb(99, 23, 23));
        gc.setFill(Color.rgb(99, 23, 23));
        gc.beginPath();
