...
/**
 * Dibujo del personaje Pollen.
 * 
 * @author Brandon Alexis Prado Castro (19051178)
 * @version 1.0. 10.09.2021
 */
public class Pollen extends Application {
    @Override
    public void start(Stage primaryStage) {
        ...
        Scene scene = new Scene(root, 500, 500, Color.rgb(238, 124, 90));
        ...
        gc.setLineWidth(1.5);
        gc.setStroke(Color.BLACK);
        gc.setFill(Color.rgb(203, 154, 49));
        gc.beginPath();
